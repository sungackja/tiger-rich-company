    ...
    <>
      ...
      <main className="min-h-screen bg-[linear-gradient(180deg,#f8f4e8_0%,#fffaf1_35%,#ffffff_100%)] text-gray-900">
        <section className="border-b border-black/5">
          <div className="mx-auto max-w-6xl rounded-[36px] bg-black px-8 py-12 text-white shadow-2xl ring-4 ring-amber-400 md:px-12 md:py-14">
            <div>
              ...
              <h1 className="mt-6 text-4xl font-bold tracking-tight md:text-5xl md:leading-tight">
                복잡한 부동산 시장,
                <br />
                길잡이가 되겠습니다
              </h1>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  href="/consult"
                  className="rounded-2xl bg-black px-6 py-3 text-base font-semibold text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 hover:bg-gray-800"
                >
                  상담 신청하기
                </Link>
            ...
            <div className="rounded-[32px] border border-white/60 bg-white/85 p-8 shadow-xl shadow-black/5 backdrop-blur">
