      ...
      <div className="mx-auto max-w-7xl">
        ...
        {error ? (
          ...
          <>
            ...
            <section className="mb-8 rounded-[28px] bg-white p-6 shadow-sm">
            ...
            {filteredConsultations.length === 0 ? (
              <div className="rounded-[28px] bg-white p-10 text-center text-gray-500 shadow-sm">
                검색 조건에 맞는 상담 신청 내역이 없습니다.
              </div>
            ) : (
              <div className="overflow-x-auto rounded-[28px] border border-gray-200 bg-white shadow-lg shadow-black/5">
